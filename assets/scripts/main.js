...
function initializeServiceWorker() {
  ...
  // sw.js is executed.
  // B1. Checks if 'serviceWorker' is supported in the current browser
  if ('serviceWorker' in navigator) {
  // B2. Listens for the 'load' event on the window object.
    window.addEventListener('load', function() {
      // B3. Registers './sw.js' as a service worker
